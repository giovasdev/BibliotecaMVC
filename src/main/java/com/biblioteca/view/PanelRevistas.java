...
public class PanelRevistas extends JPanel {
    ...
    private void inicializarComponentes() {
        ...
        tablaRevistas.getColumnModel().getColumn(0).setPreferredWidth(40);
        tablaRevistas.getColumnModel().getColumn(1).setPreferredWidth(200);
        tablaRevistas.getColumnModel().getColumn(2).setPreferredWidth(150);
        tablaRevistas.getColumnModel().getColumn(3).setPreferredWidth(60);
        tablaRevistas.getColumnModel().getColumn(4).setPreferredWidth(60);
        tablaRevistas.getColumnModel().getColumn(5).setPreferredWidth(150);
